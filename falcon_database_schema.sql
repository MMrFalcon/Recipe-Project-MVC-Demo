...
create table recipe (id bigint not null auto_increment, cook_time integer, description varchar(255), difficulty varchar(255), directions varchar(255), image longblob, prep_time integer, servings integer, notes_id bigint, primary key (id)) engine=InnoDB;
